...
dfseirtest <- seir(50,0.01,0.78889,beta,gamma,alpha,0,0)


ggplot(dfseirtest, aes(x=j)) +                                                    geom_line(aes(y = resS), color = "darkgreen") +                         geom_line(aes(y = resE), color = "yellow")+                             geom_line(aes(y = resI),color = "darkred") +                           geom_line(aes(y = resR), color="steelblue")+                              labs(title = "Modèle SEIR", x = "Temps", y="Population", color="L") +    labs(caption = "Représentation graphique.")+theme(plot.caption = element_text(hjust = 0.5, face = "italic", size =10))
```
