...
```{r}
list_res <- data.frame(replicate(50,picI2(10,0.01,0.7888999,0.6,0.03,1,1), simplify=T))
head(list_res)
...
```{r}
beta <- tirageBeta(0.6,1)
print(beta)
gamma <- tirageGamma(0.03,1)
print(gamma)
tirageAlpha(0.7,1)
```
...
```{r}
picI2Seir(50, 0.01, 0.788554,0.6,0.03,0.7,1,1,1)
...
```{r}
list_resSeir <- data.frame(replicate(50,picI2Seir(50, 0.01, 0.788554,0.6,0.03,0.7,1,1,1), simplify=T))
print(list_resSeir)
